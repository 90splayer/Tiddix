...
export const TeamsData = [
  {
    ...
    portfolio: `<strong style="color: white;">Ifeoma Adeoye</strong> <span> is the Managing Director of Tiddix Limited, a technology driven fundraising and investment solution for creatives and investors.
                ...
                <span>She has over 10 years of experience with starting, building and managing businesses to profitability. Having worked with KPMG, The Royal Bank of Scotland and FBNQuest Merchant Bank. She has acquired broad work experience within the Oil & Gas industry, financial services industry, aviation, consumer markets and public sector. She has extensive experience in advisory services covering financial advisory, business improvement, corporate strategy articulation, organisational diagnostics & transformation, market study and industry analysis. She has been involved in multiple corporate strategy execution projects, feasibility studies, business plan development, and organisation transformation projects with notable track record in strategy articulation, project management, financial analysis, financial modeling and relationship management. 
                </span><br/>`,
  },
  {
    id: '2',
    ...
    image: mark,
    job_title: 'CTO',
    portfolio: `<strong style="color: white;">Mark Gray</strong> 
                <span> 
